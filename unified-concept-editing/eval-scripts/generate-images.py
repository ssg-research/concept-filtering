...
import argparse
import os
def generate_images(model_name, prompts_path, save_path, device='cuda:0', guidance_scale = 7.5, image_size=512, ddim_steps=100, num_samples=10, from_case=0, till_case=1000000, base='1.4', seed=42):
...
#     name = 'compvis-word_VanGogh-method_xattn-sg_3-ng_1-iter_1000-lr_1e-05'
    ...
    folder_path = f'{save_path}/{model_name.replace("diffusers-","").replace(".pt","")}/{str(args.seed)}'
    ...
    for case_number, prompt in enumerate(prompts):
        ...
        for num, im in enumerate(pil_images):
            ...
            print(f'Saved image at path: {f"{folder_path}/{case_number}_{num}.png"}')

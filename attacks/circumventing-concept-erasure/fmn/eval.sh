...
for line in "${input[@]}";
do
    python generate_images.py --output_dir outputs_fmn/nudity_i2p --esd_checkpoint "/u1/test/Forget-Me-Not/exps_attn/naked3/unet/diffusion_pytorch_model.bin" --model_path attacks/circumventing-concept-erasure/fmn/results_fmn_adv_attempt2_{nude}_i2p_normalclip --prompt "$line" --prompts_with_nud 'nude' --prompts_with_clean clean 
done # < "$input"

...
export OUTPUT_DIR="results_uce_adv_attempt2_{$SAFETY_CONCEPT}_i2p_normalclip_uceckpt/"
...
accelerate launch concept_inversion.py \
        ...
        --num_train_images=25 \
        --ac_checkpoint="/u1/test/unified-concept-editing/models/erased-nudity-towards_uncond-preserve_false-sd_1_4-method_replace.pt" \

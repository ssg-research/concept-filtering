...
def main():
    ...
    if opt.save_path is None:
        opt.outdir = opt.experiment + opt.outdir_suffix.split('_')[1] + '_' + str(opt.seed)
    else:
        opt.outdir = opt.save_path + '_' + str(opt.seed)
                    ...
                    for prompts in tqdm(data, desc="data"):
                        ...
                        if not opt.skip_save:
                            for x_sample in x_samples_ddim:
                                ...
                                print(f'Saved here: {os.path.join(sample_path, f"{base_count:05}.png")}')
                                base_count += 1

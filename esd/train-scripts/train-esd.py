...
if __name__ == '__main__':
    ...
    parser.add_argument('--prompt', help='prompt corresponding to concept to erase', type=str, default='Nudity')
    ...
    parser.add_argument('--ckpt_path', help='ckpt path for stable diffusion v1-4', type=str, required=False, default='/u1/stable-diffusion-copy/stable-diffusion/models/ldm/sd-v1-4-full-ema.ckpt') # Change this line
    ...
    print(f'Total running time taken: {end - start}')
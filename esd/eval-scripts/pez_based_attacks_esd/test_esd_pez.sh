...
#     --prompts_path attacks/hard-prompts-made-easy/adv_prompts_attack_on_nudity_normalclip_i2p_nonadaptive__sampled200.txt \
#     --save_path 'outputs_pez/stanford_esd_nud_i2p' \
#     --num_samples 10 \
#     
#     # --prompts_path attacks/hard-prompts-made-easy/adv_prompts_attack_on_nudity_normalclip_nonadaptive_.txt \
...
#     --prompts_path attacks/hard-prompts-made-easy/adv_prompts_attack_on_marvel_normalclip_nonadaptive_.txt\
#     --save_path 'outputs_pez/stanford_esd_marvel' \
#     --num_samples 10 \
#     
...
#     --prompts_path 'attacks/hard-prompts-made-easy/adv_prompts_attack_on_nemo_normalclip_nonadaptive_.txt' \
#     --save_path 'outputs_pez/stanford_esd_nemo' \
#     --num_samples 10 \
#     
...
#     --prompts_path 'attacks/hard-prompts-made-easy/adv_prompts_attack_on_grumpy_normalclip_nonadaptive_.txt' \
#     --save_path 'outputs_pez/stanford_esd_grumpy_cat' \
#     --num_samples 10 \
#     
...
#     --prompts_path 'attacks/hard-prompts-made-easy/adv_prompts_attack_on_r2d2_normalclip_nonadaptive_.txt' \
#     --save_path 'outputs_pez/stanford_esd_r2d2' \
#     --num_samples 10 \
#     
...
#     --prompts_path 'attacks/hard-prompts-made-easy/adv_prompts_attack_on_snoopy_normalclip_nonadaptive_.txt' \
#     --save_path 'outputs_pez/stanford_esd_snoopy' \
#     --num_samples 10 \
#     
...
#     --prompts_path 'attacks/hard-prompts-made-easy/adv_prompts_attack_on_jolie_normalclip_nonadaptive_.txt' \
#     --save_path 'outputs_pez/stanford_esd_jolie' \
#     --num_samples 10 \
#     
...
#     --prompts_path 'attacks/hard-prompts-made-easy/adv_prompts_attack_on_swift_normalclip_nonadaptive_.txt' \
#     --save_path 'outputs_pez/stanford_esd_swift' \
#     --num_samples 10 \
#     
...
#     --prompts_path 'attacks/hard-prompts-made-easy/adv_prompts_attack_on_musk_normalclip_nonadaptive_.txt' \
#     --save_path 'outputs_pez/stanford_esd_musk' \
#     --num_samples 10 \
#     
...
#     --prompts_path 'attacks/hard-prompts-made-easy/adv_prompts_attack_on_pitt_normalclip_nonadaptive_.txt' \
#     --save_path 'outputs_pez/stanford_esd_pitt' \
#     --num_samples 10 \
#     
...
python eval-scripts/generate-images.py --model_name='stable-diffusion-copy/stable-diffusion/models/diffusers-word_violent-method_noxattn-sg_3-ng_1-iter_1000-lr_1e-05/diffusers-word_violent-method_noxattn-sg_3-ng_1-iter_1000-lr_1e-05.pt' \
    --save_path 'outputs_pez/stanford_esd_violence_i2p' \
    --num_samples 10 \
    
    --prompts_path attacks/hard-prompts-made-easy/adv_prompts_attack_on_violence_normalclip_i2p_nonadaptive__sampled200.txt 
        # --prompts_path 'attacks/hard-prompts-made-easy/adv_prompts_attack_on_violence_normalclip_nonadaptive_.txt' \

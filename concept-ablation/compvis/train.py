...
def get_parser(**parser_kwargs):
    ...
    parser.add_argument(
        ...
        "--base",
        nargs="*",
        metavar="configs/finetune_style.yaml",
...
class CUDACallback(Callback):
    ...
    def on_train_epoch_start(self, trainer, pl_module):
        ...
        # torch.cuda.reset_peak_memory_stats(trainer.strategy.root_device.index) # Only using the 1 gpu, so no sync needed
...
if __name__ == "__main__":
    ...
    try:
        ...
        if opt.prompts is None:
            ...
            opt.datapath = str(gen_folder / 'images0.txt')
            opt.caption = str(gen_folder / 'caption0.txt')
            if opt.regularization:
                opt.datapath2 = str(gen_folder / 'images0.txt')
                opt.caption2 = str(gen_folder / 'caption0.txt')

...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default='/u1/test/concept-ablation/compvis/configs/finetune_object.yaml',
        type=str,
    ...
    parser.add_argument("--device", type=str, default = 'cuda:0', help="Device to use (e.g. cpu, cuda:0, cuda:1, etc.)")
    parser.add_argument(
        "--stable_unclip",
        type=str,
        default=None,
